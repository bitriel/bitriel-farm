...
library YieldMath {
    ...
    function computeYieldAmount(
        ...
        uint256 totalSecondsUnclaimedX128 = ((currentTime - startTime) << 128) - totalSecondsClaimedX128;

        reward = FullMath.mulDiv(totalYieldUnclaimed, secondsInsideX128, totalSecondsUnclaimedX128);
    }
}