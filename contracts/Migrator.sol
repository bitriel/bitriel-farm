...
import '@bitriel/bitrielswap-periphery/contracts/base/PeripheryImmutableState.sol';
import '@bitriel/bitrielswap-periphery/contracts/base/Multicall.sol';
import '@bitriel/bitrielswap-periphery/contracts/base/SelfPermit.sol';
import '@bitriel/bitrielswap-periphery/contracts/base/PoolInitializer.sol';
import '@bitriel/bitrielswap-periphery/contracts/interfaces/INonfungiblePositionManager.sol';
import '@bitriel/bitrielswap-periphery/contracts/interfaces/external/IWETH9.sol';
...
contract Migrator is IMigrator, PeripheryImmutableState, PoolInitializer, Multicall, SelfPermit {
    ...
    function migrate(MigrateParams calldata params) external override returns(uint256 tokenId) {
        ...
        require(params.deadline >= block.timestamp, 'ME'); // Migrate expired
