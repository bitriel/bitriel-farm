...
interface IBitrielSwapRouterInterface extends ethers.utils.Interface {
  functions: {
...
export class IBitrielSwapRouter extends Contract {
  ...
  interface: IBitrielSwapRouterInterface;
